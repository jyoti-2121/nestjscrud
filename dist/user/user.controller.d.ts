...
export declare class UserController {
    ...
    findOne(id: string): Promise<import("mongoose").Document<unknown, {}, import("./schema/user").userDocument> & Omit<import("./schema/user").user & import("mongoose").Document<any, any, any> & {
        _id: import("mongoose").Types.ObjectId;
    }, never>>;
